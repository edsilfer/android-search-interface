package br.com.edsilfer.searchinterface.service
...
import br.com.edsilfer.searchinterface.model.intf.ISearchBarManager
    ...
    private fun addSearchTypedListener() {
        mInput.addTextChangedListener(object : EnhancedTextWatcher(mInput) {
            override fun onTextChanged(cursor: Int, isBackspace: Boolean, deletedChar: Char) {
                mActivity.showIndeterminateProgressBar(Color.parseColor(mPreset.getColorByID("loading").value))
